...
export const zhCN: MessageCatalog = {
  ...
  "update.readyToRestart": "下载完成，重启应用以安装",
  "update.restart": "重启应用",
  "update.install": "下载并安装更新",
  "update.failed": "更新失败",
  "update.desktopOnly": "应用内更新仅在桌面版可用，Web 开发版请使用 GitHub Release。",
  "update.experimentalBadge": "实验版",
  "update.experimentalNote": "当前为实验性预发布版本，更新可能存在不稳定风险。建议升级前备份 %APPDATA%\\Lang Drill Agent 数据目录。",
  "update.currentVersion": "当前版本",
  "update.newVersion": "新版本",
  "update.releaseNotes": "更新说明",
  "update.signatureStatus": "签名验证",
  "update.signatureVerified": "由 Tauri updater 自动校验，失败将拒绝安装",
  "update.downloadSize": "下载大小",
  "update.unknown": "未知",
  "update.openLog": "打开日志目录",
  "update.help": "查看帮助",
  "update.viewNotes": "在 GitHub 查看",
  "update.errorHint": "可重试或打开日志目录排查；多次失败请检查网络或前往 GitHub Release 手动下载。"
};
