...
export const jaJP: MessageCatalog = {
  ...
  "update.available": "新版本が見つかりました",
  "update.downloading": "更新をダウンロード中...",
  "update.readyToRestart": "ダウンロード完了、再起動してインストール",
  "update.restart": "アプリを再起動",
  "update.install": "更新をダウンロードしてインストール",
  "update.failed": "更新に失敗",
  "update.desktopOnly": "アプリ内更新はデスクトップ版のみ利用可能。Web 開発版は GitHub Release を使用してください。",
  "update.experimentalBadge": "実験版",
  "update.experimentalNote": "現在は実験的プレリリース版です。更新が不安定な場合があります。アップグレード前に %APPDATA%\\Lang Drill Agent データディレクトリをバックアップしてください。",
  "update.currentVersion": "現在のバージョン",
  "update.newVersion": "新版本",
  "update.releaseNotes": "更新説明",
  "update.signatureStatus": "署名検証",
  "update.signatureVerified": "Tauri updater が自動検証し、無効な署名はインストールを拒否します",
  "update.downloadSize": "ダウンロードサイズ",
  "update.unknown": "不明",
  "update.openLog": "ログディレクトリを開く",
  "update.help": "ヘルプを表示",
  "update.viewNotes": "GitHub で表示",
  "update.errorHint": "再試行するかログディレクトリを開いて調査してください。繰り返し失敗する場合はネットワークを確認するか、GitHub Release から手動でダウンロードしてください。"
};
