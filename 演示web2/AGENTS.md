...
本目录是 lang-drill-agent 的第二版独立产品展示网站，与 `../演示web/` 并存、不同风格。父项目 AGENTS.md 位于 `../AGENTS.md`（工作区外，只读引用），GitHub 仓库 `https://github.com/q2955161835-debug/lang-drill-agent`（Private）。
...
GitHub Pages 部署：将 `dist/` 内容推送到 `lang-drill-agent` 仓库的 `gh-pages` 分支或 main 分支 `/docs` 目录，URL 为 `https://q2955161835-debug.github.io/lang-drill-agent/`。
...
- GitHub 仓库：`https://github.com/q2955161835-debug/lang-drill-agent`（Private）
